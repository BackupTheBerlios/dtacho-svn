/*
    $Id:SecurityDataSignatureCheck.java 26 2008-02-25 22:28:27Z deetee $
 ...
 */
public class SecurityDataSignatureCheck {
	...
	private Signature cipheredSignature;
	private Signature decipheredSignature;
	
	
	/**
	 * Constructor for a DataSignatureCheck object
	 */
	public SecurityDataSignatureCheck() {
		DataByteArray = new byte[ 0 ];
		DataHexString = new String();

		DataSHAHash = new byte[ 20 ];
		...
		cipheredSignature = new Signature();
		decipheredSignature = new Signature();
	}
	...
	public void setDataByteArray( byte[] dataByteArray ) {
		...
		DataHexString = new SecurityByteArrayTools().ByteArrayToHexString( dataByteArray );
	}
	...
	public void setDataHexString( String dataHexString ) {
		DataByteArray = new SecurityByteArrayTools().HexStringToByteArray( dataHexString );
	...
	public String getDataSHAHashHexString() {
			return new SecurityByteArrayTools().ByteArrayToHexString( this.getDataSHAHashByteArray() );
	}
	...
	public byte[] getCipheredSignature() {
		return cipheredSignature.getSignature();
	}
	...
	public void setCipheredSignature( byte[] cipheredSignature ) {
		byte[] cipheredSignatureTemp = new byte[ 128 ];
		System.arraycopy( cipheredSignature, 0, cipheredSignatureTemp, 0, 128 );
		this.cipheredSignature = new Signature( cipheredSignatureTemp );
	}
	...
	public void decipherSignature() {
		try {
			...
			decipheredSignature.setSignature( mycipher.doFinal( cipheredSignature.getSignature(), 0, 128 ) );
		}
