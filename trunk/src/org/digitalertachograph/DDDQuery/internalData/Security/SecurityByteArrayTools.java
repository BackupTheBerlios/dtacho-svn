/*
    $Id:SecurityByteArrayTools.java 26 2008-02-25 22:28:27Z deetee $
...
/**
 * The SecurityByteArrayTools class provides methods to convert
 * byte arrays to hex strings and vice versa.
 */
public class SecurityByteArrayTools {
	 ...
	 * 
	 * @param	hexString	the hex string to be converted to a byte array. The special
	 * 						chars 'A-F' are handled case-insensitive.
	 *
	 ...
	 * 
	 * @return	hex string representation of the byte array. The special
