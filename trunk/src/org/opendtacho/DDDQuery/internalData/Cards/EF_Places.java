...
import org.opendtacho.DDDQuery.internalData.DataTypes.CardPlaceDailyWorkPeriod;
...
public class EF_Places extends DataClass{
	 ...
	 * Only valid after instantiation of the EF_Places object.
	 */
	...
	public EF_Places( byte[] value, short noOfCardPlaceRecords ) {
		...
		size = cardPlaceDailyWorkPeriod.size;
	}
