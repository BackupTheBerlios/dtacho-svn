<head>
	...
	<title>Create DtRequestMap</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">DtRequestMap List</g:link></span>
	</div>

	<div class="body">
		<h1>Create DtRequestMap</h1>
		...
		<g:form action="save">
			<div class="dialog">
				...
				<tbody>
					...
					<tr class="prop">
						<td valign="top" class="name"><label for="configAttribute">DtRole (comma-delimited):</label></td>
