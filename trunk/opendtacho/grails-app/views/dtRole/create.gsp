...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">DtRole List</g:link></span>
	</div>
	...
	<div class="body">
		...
		<tbody>
			<tr class="prop">
				<td valign="top" class="name"><label for="authority">DtRole Name:</label></td>
